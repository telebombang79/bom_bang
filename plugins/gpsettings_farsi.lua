...
elseif lang then
 return "🔐ارسال کلمات فارسی/فارسی در گروه قفل است🔐"
end
else
...
if not lang then
 ...
 return "🔐ارسال کلمات فارسی/فارسی در گروه قفل شد🔐"
end
end
end
...
elseif lang then
return "🔓ارسال کلمات فارسی/فارسی در گروه باز است🔓"
end
else 
...
return "🔓ارسال کلمات فارسی/فارسی در گروه باز شد🔓"
end
end
end
